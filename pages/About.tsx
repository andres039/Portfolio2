    ...
    <div>
      <Container sx={{ my: "1rem", p: 2 }}>
        ...
        <Typography paragraph>
          ...
          ‘met’ the backend with PostgreSQL, Express, Node, and a bit of Ruby on
          Rails. I have been using React for all of my current projects after
          the BootCamp. One of my biggest achievements has been the application
          of TypeScript to React, and the recent possibility of joining an open
          ...
          energy into the development of great applications.
        </Typography>
      </Container>
    </div>
  );
